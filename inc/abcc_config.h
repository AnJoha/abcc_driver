...
** If 1 the ABCC_SYS_GetOpmode() function must be implemented in the system
** adaption layer.
**
...
** If 1 the ABCC_SYS_SetOpmode() function must be implemented in the system
** adaption layer.
**------------------------------------------------------------------------------
*/
...
** If 0 the following functions must be implemented in the system adaption
** layer:
...
** hardware. If 1 the ABCC_SYS_ReadModuleId() function must be implemented
** in the system adaption layer. If 0 module identification
...
** in use. If 1 the ABCC_SYS_ModuleDetect() function in the system adaption
...
** If 1 ABCC_SYS_SyncInterruptEnable() and ABCC_SYS_SyncInterruptDisable()
...
** startup interrupt.
**
** If 1 the user must implement the ABCC_SYS_IsAbccInterruptActive() function
...
** When ABCC_CFG_SYNC_MEASUREMENT_IP_ENABLED is 1 ABCC_SYS_GpioReset() is
...
** compiling special test versions of the product.
** When ABCC_CFG_SYNC_MEASUREMENT_OP_ENABLED is 1 ABCC_SYS_GpioSet() is called
