...
**------------------------------------------------------------------------------
*/
#define ABCC_LOG_SEVERITY_FATAL_ENABLED 0
#define ABCC_LOG_SEVERITY_ERROR_ENABLED 1
#define ABCC_LOG_SEVERITY_WARNING_ENABLED 2
#define ABCC_LOG_SEVERITY_INFO_ENABLED 3
#define ABCC_LOG_SEVERITY_DEBUG_ENABLED 4
